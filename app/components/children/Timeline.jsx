                            ...
                            <div className="col-md-12">
                                <div className="timeline">
                                    <div className="timeline-inner">
                                        ...
                                        {/* <!-- Single Timeline --> */}
                                        <div className="single-main wow fadeInLeft" data-wow-delay="0.6s">
                                            <div className="single-timeline">
                                                <div className="single-content">
                                                    <div className="date">
                                                        <p>Nov<span>2015</span></p>
                                                    </div>
                                                    <h2>Move to U.S.</h2>
